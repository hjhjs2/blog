...
function playAudio2() { 
    ...
    musicName.innerHTML = '\" 거짓말처럼 (Eng Ver.) \"';
...
function onClickNum1() {
    // console.log('click');
    musicName.innerHTML = '\" 따뜻하던 손 끝으로 다만 담담하게 나를 안아주고 \"';
}
num1.addEventListener('click', onClickNum1);

function onClickNum2() {
    // console.log('click2');
    musicName.innerHTML = '\" Is my heart getting faded out? \"';
}
