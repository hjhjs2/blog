...
function playAudio2() { 
    ...
    musicName.innerHTML = '\" Be There (Radio Ver.) \"';
...
function onClickNum1() {
    // console.log('click');
    musicName.innerHTML = '\" 밤하늘 은하수로 와줘요, 눈부신 저 너머로. \"';
}
num1.addEventListener('click', onClickNum1);

function onClickNum2() {
    // console.log('click2');
    musicName.innerHTML = '\" 따뜻한 별들 속 한 가운데 먼저 찾아줘요. \"';
}
